...
<div class="row">
    ...
    <div class="col s4 right-align">
        ...
        <br />
        <a href="{{route('ushare.filedownload', ['path' => $current_folder == null ? '/'.$file['fullfilename'] : $current_folder.'/'.$file['fullfilename']])}}"
            class="tooltipped" data-tooltip="Download"><i class="material-icons blue-text">cloud_download</i></a>
        <br />
        @if($file['filevideourl'] === null)
        @else
        <a href="{{route('ushare.filestream', ['path' => $current_folder == null ? '/'.$file['fullfilename'] : $current_folder.'/'.$file['fullfilename']])}}"
        ...
        <div class="modal-content">
            ...
            <div class="row">
                <div class="input-field col s12 centered">
                    ...
                    <label for="fileDisplay">Copy file</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col s12 centered">
